...
<div class="container-fluid" style="background-image: url(./src/img/bg.png);">
    ...
    <div class="row">
        ...
        <div class="col-md-9 ">
            <p class="text-light h3 me-5" style="text-shadow: grey 2px 3px;">
    ...
    <div class="row">
        <div class="col-md-6 text-center"><img src="./src/img/Les_annonces1.png" style="width: 85%; height:95%" alt="les_annonces"></div>
        <div class="col-md-6 text-center"><img src="./src/img/Mon_profil_1.png" style="width: 85%; height:95%" alt="mon_profil"></div>
    </div>
</div>